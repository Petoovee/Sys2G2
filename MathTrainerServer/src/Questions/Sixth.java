...
public class Sixth extends Course {
	...
	private void initGeometryQuestions() {
		...
		String q3 = "En triangel har sidlängderna 7 cm, 41 mm och 62 mm. Observera enheterna." + n
	...
	private void initRandomlyQuestion() {
		...
		String q6 = "En triangel har sidlängderna 7 cm, 41 mm och 62 mm. Observera enheterna." + n
				+ " Hur stor omkrets har denna triangel i centimeter?";
