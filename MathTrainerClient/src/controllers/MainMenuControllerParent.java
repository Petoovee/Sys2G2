...
/**
 * An abstract class that extends the SceneController, as this too will be used
 * by scene controllers. All Main Menu controllers extend this class. It defines
 * the code for the left menu panel which stays the same until you leave the
 * main menu completely.
 * 
...
public abstract class MainMenuControllerParent extends SceneControllerParent {
	...
	/**
	 * Changes to the scene for choice of exercise categories when the user clicks
	 * Exercises.
	 * 
	 * @param actionEvent
	 */
	...
	/**
	 * Handles the exit event if user clicks "Exit". The MainController handles this
	 * event manually.
	 * 
	 * @param actionEvent
	 */
