...
/**
 * Controller for handling button-presses in the scene Home.fxml. It contains
 * only a method to initialize correct values. The controller, as all other
 * controllers that are part of the Main menu, extends the
 * MainMenuControllerParent.
 * 
