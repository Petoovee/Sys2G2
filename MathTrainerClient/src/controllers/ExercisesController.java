...
/**
 * Controller ExercisesController handles the Exercises scene where the user can
 * select which quiz they want to enter, the method reads the user input and
 * starts the relevant quiz, this controller extends MainMenuControllerParent
 * 
...
public class ExercisesController extends MainMenuControllerParent {
	...
	/**
	 * This method is used when the user hits the button to select which quiz they
	 * want to enter.
	 *
