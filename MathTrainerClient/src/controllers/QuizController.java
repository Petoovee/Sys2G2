...
/**
 * Class QuizController that extends SceneControllerParent that handles the fxml
 * file Quiz.fxml and creates actions in the Scene
 * 
...
public class QuizController extends SceneControllerParent implements InitializeSceneInterface {
	...
	/**
	 * This method is used both when the user hits the button to move to previous
	 * question while in the quiz.
	 * 
	...
	/**
	 * This method is used when the label at the top right of the screen needs to be
	 * updated when the user moves on to the next question and/or previous question
	 * 
	 * @param nextQuestion Boolean that is true if the ueser is in the next question
	...
	/**
	 * This method is used to check if the answer from the user is correct and gets
	 * sent to questions array so it can be used in QuizCompletedController to send
	 * the final score to the final scene.
	 * 
	 * @param questionNumber the number that is shown at the top right section of
	 *                       the screen (where the user is in the quiz).
	 */
	public void checkAnswer(int questionNumber) {
		...
		if (selectedButton.getText().equals(questions[questionNumber].getAnswer())) {
			...
			questions[questionNumber].correctAnswer(false, selectedButton.getText());
		}
	}

	/**
	 * This method is used when the user hits the button to move to next question
	 * while in the quiz.
	 * 
