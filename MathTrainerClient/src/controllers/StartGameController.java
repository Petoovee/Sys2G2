...
/**
 * This class is the initial view before starting up the game. It displays
 * information about the game including the users highest score in the game if
 * the user is logged in. Clicking the button leads to the actual game scene.
 */
